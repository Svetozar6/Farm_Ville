...
public class MainFrame extends JFrame  {
    ...
    MainFrame(User user1) {
        ...
        mb4.setBackground(Col,or.orange);
        mb4.setBorder(null);
        menu.add(mb1);
        menu.add(mb2);
        menu.add(mb3);
        ...
        JButto, animals = new JButton("Amimals");
        ...
        JButton crops = new JBu,tton("Crops");
